...
<?php
    ...
    class BaseDatos {
        ...
        public function __construct(){
            ...
            $this->db->select_db('bd_ejercicio7');
        }
        ...
        public function insertarDatosClub() {
            ...
            if ($id == "") {
                ...
                $consulta = "INSERT INTO Club (id, nombre, ciudad, pais, liga, estadio) 
                                                 VALUES (?,?,?,?,?,?)";
    
                $consultaPre = $this->db->prepare($consulta);
                $consultaPre->bind_param('ssssss', $id, $nombre, $ciudad, $pais, $liga, $estadio);
                ...
                while (!feof($csv)) {
                    ...
                    if ($linea) {
                        ...
                        $consulta = "INSERT INTO Club 
                                    (id, nombre, ciudad, pais, liga, estadio) 
                                    VALUES (?,?,?,?,?,?)";
