...
<?php
    ...
    class BaseDatos {
        ...
        public function crearTabla() { 
            ...
            // Para crear la tabla PruebasUsabilidad hay que dejar el campo de texto vacío o escribir 'pruebasusabilidad'/'PruebasUsabilidad'/'pruebasUsabilidad'
            $nombreTabla = $_POST['txtCrearTabla'];
            
            if ($nombreTabla == "" || $nombreTabla == "pruebasusabilidad" || $nombreTabla == "pruebasUsabilidad" || $nombreTabla == "PruebasUsabilidad") {
    ...
    echo "  
            ...
            <form action='#' method='post' name='creacion'>
                <p>Crear la BD con nombre 'BaseDatos'</p>              
                <input type='submit' class='button' name='crearBD' value='Crear Base de Datos' />

                <label for='crearTabla'>Nombre de la tabla (PruebasUsabilidad): <input type='text' id='crearTabla' name='txtCrearTabla' /></label>
