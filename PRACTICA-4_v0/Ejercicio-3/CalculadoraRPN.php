...
if (count($_POST)>0) 
    ...
    echo "  
        ...
        <form action='#' method='post' name='botones'>
            ...
            <textarea id='pantalla' name='pantalla' disabled=disabled>$pantalla</textarea>

            <label for='subpantalla'>Subpantalla</label>
            <input type='text' id='subpantalla' name='subpantalla' value='$subpantalla' disabled=disabled />		
